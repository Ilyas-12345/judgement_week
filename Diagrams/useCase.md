...
2.5 [Удалить активность](#remove_transaction)  
...
**Описание.** Позволяет зарегистрированному пользователю удалить активность.  
**Предусловия.** Пользователь выбрал активность и нажал "Delete".  
**Основной поток.**
1. Приложение удаляет выбранную активность;
2. Приложение обновляет список активностей;
3. Вариант использования завершается.
